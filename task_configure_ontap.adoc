...
IPv6 네트워크 주소 지정이 필요한 특정 MetroCluster 배포 또는 클러스터와 같은 일부 경우에는 ONTAP CLI를 사용하여 새 클러스터를 설정해야 할 수 있습니다. 을 클릭합니다 link:https://docs.netapp.com/us-en/ontap/software_setup/concept_set_up_the_cluster.html["여기"] 이러한 요구사항에 대한 자세한 내용과 ONTAP CLI를 사용한 클러스터 설정 단계를 참조하십시오.

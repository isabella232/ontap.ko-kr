...
데이터를 제공하는 SVM만 복제할 수 있습니다. 지원되는 데이터 보호 관계 유형은 다음과 같습니다.
...
다음 표는 'napmirror create'-identity-preserve' 옵션과 'napmirror policy create'-discard-configs network' 옵션의 상호 작용을 보여줍니다.

...
| 플랫폼 | ONTAP 9.9.1 이전 릴리즈의 HA 쌍당 허용되는 SnapMirror Synchronous 작업 수입니다 | ONTAP 9.9.1에서 HA 쌍당 허용되는 SnapMirror Synchronous 작업의 수입니다 | ONTAP 9.10.1의 HA 쌍당 허용되는 SnapMirror Synchronous 작업 수입니다 | ONTAP 9.11.1의 HA 쌍당 허용되는 SnapMirror Synchronous 작업 수입니다 

...
SnapMirror 동기 및 SnapMirror 라이센스는 에 포함되어 있습니다 https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP 1 을 참조하십시오"].

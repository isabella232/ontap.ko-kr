...
+
AFF 시스템에서 추가 용량이 필요하거나, 비 AFF 시스템에서 Amazon S3를 사용하거나, 기존 클러스터에서 업그레이드하는 경우 가 필요합니다 link:https://docs.netapp.com/us-en/ontap/fabricpool/install-license-aws-azure-ibm-task.html["FabricPool 라이센스"].

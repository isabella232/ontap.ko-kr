...
image::../media/namespace-architecture-with-single-branched-tree.gif[단일 분기 트리가 있는 네임스페이스입니다]
...
image::../media/namespace-architecture-with-multiple-branched-trees.png[여러 개의 분기 트리가 있는 네임스페이스입니다]
...
image::../media/namespace-architecture-with-multiple-standalone-volumes.gif[여러 개의 독립 실행형 볼륨이 있는 네임스페이스]

...
----
. 에 설명된 단계를 참조하십시오 link:../mediator/manage-task.html#Replace-self-signed-certificates-with-trusted-third-party-certificates["자체 서명된 인증서를 신뢰할 수 있는 타사 인증서로 바꿉니다"] 하위 CA에서 인증서를 가져오는 방법에 대해 설명합니다 `ca.crt`.
+

...
| System Manager Classic(ONTAP 9.7 이하) | https://docs.netapp.com/us-en/ontap-sm-classic/nas-multiprotocol-config/index.html["SMB 및 NFS 멀티 프로토콜 구성 개요"^] 
...
* link:nfs-config/index.html["CLI를 사용한 NFS 구성 개요"]
* link:nfs-admin/security-styles-their-effects-concept.html["보안 스타일과 그 효과는 무엇입니까"]

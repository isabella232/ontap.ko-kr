...
MOTD에 대한 콘텐츠를 동적으로 생성하는 데 사용할 수 있는 이스케이프 시퀀스 목록은 을 참조하십시오 link:https://docs.netapp.com/us-en/ontap-cli-9131//security-login-motd-modify.html#parameters["명령 참조"].

...
====
AutoSupport OnDemand를 사용하지 않도록 설정하고 AutoSupport를 계속 사용하려면 다음 명령을 사용하십시오. link: https://docs.netapp.com/us-en/ontap-cli-9121/system-node-autosupport-modify.html#parameters[`system node autosupport modify -ondemand-state disable`].

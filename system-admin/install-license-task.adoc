...
summary: 'NLF를 설치하는 기본 방법인 System Manager를 사용하여 NetApp 라이센스 파일 및 라이센스 키를 설치하거나 ONTAP CLI를 사용하여 라이센스 키를 설치할 수 있습니다. ONTAP 9.10.1 이상에서는 NetApp 라이센스 파일(NLF)을 통해 기능이 활성화되고, ONTAP 9.10.1 이전 릴리스에서는 라이센스 키를 사용하여 ONTAP 기능을 사용할 수 있습니다. ' 
---
= ONTAP 라이센스를 설치합니다
:allow-uri-read: 
:icons: font
...
[role="lead"]
NLF를 설치하는 기본 방법인 System Manager를 사용하여 NetApp 라이센스 파일 및 라이센스 키를 설치하거나 ONTAP CLI를 사용하여 라이센스 키를 설치할 수 있습니다. ONTAP 9.10.1 이상에서는 NetApp 라이센스 파일(NLF)을 통해 기능이 활성화되고, ONTAP 9.10.1 이전 릴리스에서는 라이센스 키를 사용하여 ONTAP 기능을 사용할 수 있습니다.

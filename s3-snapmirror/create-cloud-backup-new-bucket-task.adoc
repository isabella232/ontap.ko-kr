...
summary: 새로운 S3 버킷을 생성할 때 StorageGRID 시스템 또는 AWS S3 구축과 같은 오브젝트 저장소 공급자의 S3 SnapMirror 타겟 버킷에 즉시 백업할 수 있습니다. 
---
...
[role="lead"]
새로운 S3 버킷을 생성할 때 StorageGRID 시스템 또는 AWS S3 구축과 같은 오브젝트 저장소 공급자의 S3 SnapMirror 타겟 버킷에 즉시 백업할 수 있습니다.

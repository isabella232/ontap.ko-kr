...
+
'보안 로그인 생성 - vserver SVM_name -user -or -group -name user_name -application application -AuthMethod nsswitch -role role role -comment comment -is -ns -switch -group yes | no'

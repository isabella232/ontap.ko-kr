...
NOTE: 를 사용할 수 있습니다 `security login role config modify` 지정된 역할과 연결된 계정의 암호 규칙을 수정하는 명령입니다. 자세한 내용은 를 참조하십시오 link:https://docs.netapp.com/us-en/ontap-cli/security-login-role-config-modify.html["명령 참조"^].

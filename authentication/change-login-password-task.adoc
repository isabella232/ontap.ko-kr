...
NOTE: 명령을 사용하여 지정된 역할과 연결된 계정의 암호 규칙을 수정할 수[`security login role config modify` 있습니다. ONTAP 명령 참조에서 https://docs .NetApp.com/us-en/ONTAP-cli/security-login-role-config-modify.html 명령 링크에 대해 자세히[`security login role config modify` 알아보십시오.

...
. 복원할 소스 볼륨 옆에 있는 을 image:icon_kabob.gif["메뉴 옵션"] 클릭하여 메뉴를 표시하고 * Restore * 를 선택합니다.
...
. 을 클릭합니다 image:icon_kabob.gif["메뉴 옵션"] 소스 볼륨 옆에 있는 * Delete * 를 선택합니다.
...
.단계
. 보호 > 개요 > 클라우드 오브젝트 저장소 * 를 클릭합니다.
. 삭제할 오브젝트 저장소를 선택하고 을 클릭합니다 image:icon_kabob.gif["메뉴 옵션"] 를 선택하고 * 삭제 * 를 선택합니다.

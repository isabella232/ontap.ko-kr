...
summary: '기본적으로 인증되지 않은 익명 사용자(null 사용자라고도 함)는 네트워크의 특정 정보에 액세스할 수 있습니다. CIFS 서버 옵션을 사용하여 익명 사용자에 대한 액세스 제한을 구성할 수 있습니다.' 
---
...
[role="lead"]
기본적으로 인증되지 않은 익명 사용자(_null user_ 라고도 함)는 네트워크의 특정 정보에 액세스할 수 있습니다. CIFS 서버 옵션을 사용하여 익명 사용자에 대한 액세스 제한을 구성할 수 있습니다.

익명 제한 CIFS 서버 옵션은 Windows의 RestrictAnonymous 레지스트리 항목에 해당합니다.

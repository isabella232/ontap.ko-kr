...
summary: '파일 보안 설정을 확인하여 보안 정책을 적용한 SVM(스토리지 가상 머신)의 파일 또는 폴더에 원하는 설정이 있는지 확인할 수 있습니다.' 
---
= 적용된 파일 보안을 확인합니다
:allow-uri-read: 
:icons: font
...
.단계
. 파일 및 폴더 보안 설정 표시: 'vserver security file-directory show -vserver vserver_name -path path path[-expand-mask true]'
+

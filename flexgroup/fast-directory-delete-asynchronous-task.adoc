...
ONTAP 9.8부터는 ONTAP CLI를 사용하여 빠른 디렉토리 삭제 기능을 사용할 수 있습니다. ONTAP 9.9.1부터 이 기능을 시스템 관리자와 함께 사용할 수 있습니다. 이 프로세스에 대한 자세한 내용은 을 참조하십시오 https://["분석을 기반으로 수정 조치 수행"].

[role="tabbed-block"]
====
.시스템 관리자
--
자세한 내용은 을 참조하십시오 https://["분석을 기반으로 수정 조치 수행"].

...
. FlexGroup 볼륨을 복제하려면 보조 사이트에서 'sapmirror update-destination-path destination_svm_name: - source-path source_svm_name:'+'sapmirror show-fields schedule'을 입력하여 예약된 SnapMirror 업데이트가 이미 있는지 확인할 수도 있습니다

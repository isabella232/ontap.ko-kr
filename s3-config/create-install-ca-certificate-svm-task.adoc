...
+
'보안 인증서 서명 - vserver svm_name -ca_cert_name -ca -serial ca_cert_serial_number [additional_options]'
...
+
'Security certificate install-type server-vserver svm_name'입니다

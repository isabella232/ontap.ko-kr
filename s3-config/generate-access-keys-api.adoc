...
. 클라이언트 구성을 SVM에 연결합니다. 을 참조하십시오 link:../nfs-config/enable-ldap-svms-task.html["LDAP 클라이언트 구성을 SVM과 연결합니다"] 및 https://docs.netapp.com/us-en/ontap-cli-9141//vserver-services-name-service-ldap-create.html["SVM 서비스 이름 - 서비스 LDAP 생성"].
. 데이터 스토리지 VM을 사용하는 경우 관리 네트워크 인터페이스(LIF) 및 VM에 그리고 LIF에 대한 서비스 정책을 생성합니다. 를 참조하십시오 https://docs.netapp.com/us-en/ontap-cli-9141/network-interface-create.html["네트워크 인터페이스 생성"] 및 https://docs.netapp.com/us-en/ontap-cli-9141//network-interface-service-policy-create.html["네트워크 인터페이스 서비스 - 정책 생성"] 명령.

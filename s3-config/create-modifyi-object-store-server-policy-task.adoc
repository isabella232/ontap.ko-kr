...
또한 새 사용자 지정 정책을 만든 다음 새 사용자 및 그룹에 대한 새 문을 추가하거나 기존 문의 특성을 수정할 수도 있습니다. ONTAP 명령 참조에서 https://docs.NetApp.com/us-en/ONTAP-cli/index.html] 명령에 대해 자세히[`vserver object-store-server policy` 알아보십시오.

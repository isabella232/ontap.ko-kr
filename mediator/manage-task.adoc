...
CAUTION: 타사 인증서는 특정 ONTAP 버전의 ONTAP 중재자에서만 지원됩니다. 을 참조하십시오. link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-243278["NetApp 버그 온라인 버그 ID CONTAP-243278"^]

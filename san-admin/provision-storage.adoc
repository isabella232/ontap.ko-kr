...
System Manager Classic(9.7 이하에서 사용 가능)을 사용하여 이 작업을 완료하려면 을 참조하십시오 https://["Red Hat Enterprise Linux용 iSCSI 구성"^]
...
https://["System Manager에서 SAN 이니시에이터 그룹을 보고 관리합니다"]

...
에 대한 자세한 내용은 man 페이지를 참조하십시오 link:https://docs.netapp.com/us-en/ontap-cli-9131/volume-efficiency-inactive-data-compression-modify.html#description["비활성 데이터 압축 수정"].

...
.시작하기 전에
* ONTAP 9.13.1 부터는 새 볼륨에 대해 용량 분석 및 활동 추적을 기본적으로 활성화할 수 있습니다. System Manager에서 클러스터 또는 스토리지 VM 레벨의 기본 설정을 관리할 수 있습니다. 자세한 내용은 을 https://docs.netapp.com/us-en/ontap/task_nas_file_system_analytics_enable.html["파일 시스템 분석 설정"]참조하십시오.

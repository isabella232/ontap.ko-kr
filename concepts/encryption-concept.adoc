...
ONTAP 9.7부터 새로 생성된 애그리게이트와 볼륨은 가 있는 경우 기본적으로 암호화됩니다 link:https://docs.netapp.com/us-en/ontap/system-admin/manage-license-task.html#view-details-about-a-license["NVE 라이센스"] 온보딩 또는 외부 키 관리

...
|===
+
전체 명령 구문은 명령 참조 페이지에서 link:https://docs.netapp.com/us-en/ontap-cli-9141/volume-create.html를 참조하십시오[`volume create`^].
...
+
전체 명령 구문은 을 참조하십시오 link:https://docs.netapp.com/us-en/ontap-cli-9141/volume-show.html["명령 참조"^].

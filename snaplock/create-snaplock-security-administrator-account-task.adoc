...
SnapLock 역할은 데이터 SVM과 연결된 vsadmin-SnapLock 역할과는 달리 클러스터 SVM과 연결됩니다.
...
+
다음 명령을 실행하면 SnapLock 역할이 사전 정의된 SVM 관리자 계정 'napLockAdmin'에서 암호를 사용하여 VM2에 액세스할 수 있습니다.

...
ONTAP 9.10.1부터는 SnapLock 애그리게이트를 생성할 수 없습니다. 에는 -snaplock-type 옵션을 사용해야 합니다 link:https://docs.netapp.com/us-en/ontap/snaplock/create-snaplock-volume-task.html["SnapLock 볼륨을 명시적으로 생성합니다"] SnapLock 형식으로 Compliance 또는 Enterprise를 지정합니다.

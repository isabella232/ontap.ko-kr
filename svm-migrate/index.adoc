...
* 소스 및 대상 클러스터에 SnapMirror 동기식 구성이 있어야 합니다 link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["라이센스가 설치되었습니다"]. 이 라이센스는 에 포함되어 있습니다 link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP 1 을 참조하십시오"].
...
| SnapMirror Cloud 관계 | ONTAP 9.12.1 | ONTAP 9.12.1부터 SnapMirror 클라우드 관계와 SVM을 마이그레이션할 때 타겟 클러스터에 가 있어야 합니다 link:https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license["SnapMirror Cloud 라이센스"] 설치되어 있어야 하며, 클라우드로 미러링되는 볼륨의 용량 이동을 지원할 수 있는 충분한 용량이 있어야 합니다. 
